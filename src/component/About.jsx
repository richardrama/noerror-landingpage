...
const About = () => {
    return (
        <div className={`relative sm:mt-[100px] w-full ${styles.boxWidth} sm:h-[90vh] mb-[100px]`}>
            ...
            <img src="/noerror-landingpage/src/assets/background-code.png" alt="code-background" className='w-[178px] sm:w-[500px] lg:w-[auto] absolute z-[1] bottom-[50px] sm:bottom-[0] right-[20px] sm:right-[78px]' />
