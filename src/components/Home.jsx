...
const Home = () => {
    return (
        <div className='grid place-items-center w-full max-w-[1440px] relative h-[90vh]'>
            ...
            <img src={logoBackground} alt="" className='absolute z-[1] w-[237px] sm:w-[auto]' />
            <div className='z-[2] flex flex-col items-center'>
                <h1 className='text-white font-[700] text-[32px] mx-[25px] sm:mx-[0] sm:text-[64px] max-w-[850px] text-center '>Your <span className='italic'>Progress</span> is <br></br> What We <span className='italic text-green'>Value</span> the Most</h1>
